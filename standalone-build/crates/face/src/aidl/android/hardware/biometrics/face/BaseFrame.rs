...
#[derive(Debug)]
pub struct r#BaseFrame {
  pub r#acquiredInfo: crate::mangled::_7_android_8_hardware_10_biometrics_4_face_12_AcquiredInfo,
  pub r#vendorCode: i32,
  pub r#pan: f32,
  pub r#tilt: f32,
  pub r#distance: f32,
  pub r#isCancellable: bool,
}
impl Default for r#BaseFrame {
  fn default() -> Self {
    Self {
      r#acquiredInfo: crate::mangled::_7_android_8_hardware_10_biometrics_4_face_12_AcquiredInfo::UNKNOWN,
      r#vendorCode: 0,
      r#pan: 0.000000f32,
      r#tilt: 0.000000f32,
      r#distance: 0.000000f32,
      r#isCancellable: false,
    }
  }
}
impl binder::Parcelable for r#BaseFrame {
  fn write_to_parcel(&self, parcel: &mut binder::binder_impl::BorrowedParcel) -> std::result::Result<(), binder::StatusCode> {
    parcel.sized_write(|subparcel| {
      subparcel.write(&self.r#acquiredInfo)?;
      subparcel.write(&self.r#vendorCode)?;
      subparcel.write(&self.r#pan)?;
      subparcel.write(&self.r#tilt)?;
      subparcel.write(&self.r#distance)?;
      subparcel.write(&self.r#isCancellable)?;
      Ok(())
    })
  }
  fn read_from_parcel(&mut self, parcel: &binder::binder_impl::BorrowedParcel) -> std::result::Result<(), binder::StatusCode> {
    parcel.sized_read(|subparcel| {
      if subparcel.has_more_data() {
        self.r#acquiredInfo = subparcel.read()?;
      }
      if subparcel.has_more_data() {
        self.r#vendorCode = subparcel.read()?;
      }
      if subparcel.has_more_data() {
        self.r#pan = subparcel.read()?;
      }
      if subparcel.has_more_data() {
        self.r#tilt = subparcel.read()?;
      }
      if subparcel.has_more_data() {
        self.r#distance = subparcel.read()?;
      }
      if subparcel.has_more_data() {
        self.r#isCancellable = subparcel.read()?;
      }
      Ok(())
    })
  }
}
binder::impl_serialize_for_parcelable!(r#BaseFrame);
binder::impl_deserialize_for_parcelable!(r#BaseFrame);
impl binder::binder_impl::ParcelableMetadata for r#BaseFrame {
  fn get_descriptor() -> &'static str { "android.hardware.biometrics.face.BaseFrame" }
  fn get_stability(&self) -> binder::binder_impl::Stability { binder::binder_impl::Stability::Vintf }
}
pub(crate) mod mangled {
 pub use super::r#BaseFrame as _7_android_8_hardware_10_biometrics_4_face_9_BaseFrame;
}
