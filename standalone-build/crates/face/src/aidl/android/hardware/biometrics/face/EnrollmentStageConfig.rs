...
#[derive(Debug)]
pub struct r#EnrollmentStageConfig {
  pub r#stage: crate::mangled::_7_android_8_hardware_10_biometrics_4_face_15_EnrollmentStage,
  pub r#cells: Vec<crate::mangled::_7_android_8_hardware_10_biometrics_4_face_4_Cell>,
}
impl Default for r#EnrollmentStageConfig {
  fn default() -> Self {
    Self {
      r#stage: crate::mangled::_7_android_8_hardware_10_biometrics_4_face_15_EnrollmentStage::UNKNOWN,
      r#cells: Default::default(),
    }
  }
}
impl binder::Parcelable for r#EnrollmentStageConfig {
  fn write_to_parcel(&self, parcel: &mut binder::binder_impl::BorrowedParcel) -> std::result::Result<(), binder::StatusCode> {
    parcel.sized_write(|subparcel| {
      subparcel.write(&self.r#stage)?;
      subparcel.write(&self.r#cells)?;
      Ok(())
    })
  }
  fn read_from_parcel(&mut self, parcel: &binder::binder_impl::BorrowedParcel) -> std::result::Result<(), binder::StatusCode> {
    parcel.sized_read(|subparcel| {
      if subparcel.has_more_data() {
        self.r#stage = subparcel.read()?;
      }
      if subparcel.has_more_data() {
        self.r#cells = subparcel.read()?;
      }
      Ok(())
    })
  }
}
binder::impl_serialize_for_parcelable!(r#EnrollmentStageConfig);
binder::impl_deserialize_for_parcelable!(r#EnrollmentStageConfig);
impl binder::binder_impl::ParcelableMetadata for r#EnrollmentStageConfig {
  fn get_descriptor() -> &'static str { "android.hardware.biometrics.face.EnrollmentStageConfig" }
  fn get_stability(&self) -> binder::binder_impl::Stability { binder::binder_impl::Stability::Vintf }
}
pub(crate) mod mangled {
 pub use super::r#EnrollmentStageConfig as _7_android_8_hardware_10_biometrics_4_face_21_EnrollmentStageConfig;
}
