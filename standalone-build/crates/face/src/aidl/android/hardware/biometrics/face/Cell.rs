...
impl binder::Parcelable for r#Cell {
...
binder::impl_serialize_for_parcelable!(r#Cell);
binder::impl_deserialize_for_parcelable!(r#Cell);
impl binder::binder_impl::ParcelableMetadata for r#Cell {
  fn get_descriptor() -> &'static str { "android.hardware.biometrics.face.Cell" }
  fn get_stability(&self) -> binder::binder_impl::Stability { binder::binder_impl::Stability::Vintf }
}
pub(crate) mod mangled {
 pub use super::r#Cell as _7_android_8_hardware_10_biometrics_4_face_4_Cell;
}
