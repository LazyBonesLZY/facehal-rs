...
#[derive(Debug)]
pub struct r#EnrollmentFrame {
  pub r#cell: Option<crate::mangled::_7_android_8_hardware_10_biometrics_4_face_4_Cell>,
...
binder::impl_serialize_for_parcelable!(r#EnrollmentFrame);
binder::impl_deserialize_for_parcelable!(r#EnrollmentFrame);
impl binder::binder_impl::ParcelableMetadata for r#EnrollmentFrame {
  fn get_descriptor() -> &'static str { "android.hardware.biometrics.face.EnrollmentFrame" }
  fn get_stability(&self) -> binder::binder_impl::Stability { binder::binder_impl::Stability::Vintf }
}
pub(crate) mod mangled {
 pub use super::r#EnrollmentFrame as _7_android_8_hardware_10_biometrics_4_face_15_EnrollmentFrame;
}
