...
declare_binder_enum! {
  #[repr(C, align(1))]
  r#EnrollmentStage : [i8; 7] {
    r#UNKNOWN = 0,
    r#FIRST_FRAME_RECEIVED = 1,
    r#WAITING_FOR_CENTERING = 2,
    r#HOLD_STILL_IN_CENTER = 3,
    r#ENROLLING_MOVEMENT_1 = 4,
    r#ENROLLING_MOVEMENT_2 = 5,
    r#ENROLLMENT_FINISHED = 6,
  }
}
pub(crate) mod mangled {
 pub use super::r#EnrollmentStage as _7_android_8_hardware_10_biometrics_4_face_15_EnrollmentStage;
}
