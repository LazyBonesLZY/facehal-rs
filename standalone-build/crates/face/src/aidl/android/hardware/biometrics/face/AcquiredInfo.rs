...
declare_binder_enum! {
  ...
  r#AcquiredInfo : [i8; 27] {
    ...
    r#POOR_GAZE = 11,
    r#NOT_DETECTED = 12,
    r#TOO_MUCH_MOTION = 13,
    r#RECALIBRATE = 14,
    r#TOO_DIFFERENT = 15,
    r#TOO_SIMILAR = 16,
    r#PAN_TOO_EXTREME = 17,
    r#TILT_TOO_EXTREME = 18,
    r#ROLL_TOO_EXTREME = 19,
    r#FACE_OBSCURED = 20,
    r#START = 21,
    r#SENSOR_DIRTY = 22,
    r#VENDOR = 23,
    r#FIRST_FRAME_RECEIVED = 24,
    r#DARK_GLASSES_DETECTED = 25,
    r#MOUTH_COVERING_DETECTED = 26,
  }
}
pub(crate) mod mangled {
 pub use super::r#AcquiredInfo as _7_android_8_hardware_10_biometrics_4_face_12_AcquiredInfo;
}
